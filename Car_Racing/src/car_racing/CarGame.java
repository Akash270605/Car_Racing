...
public class CarGame extends JFrame implements KeyListener, ActionListener{
    ...
    public void paint(Graphics g){
        ...
        tree1= new ImageIcon("src/assets/tree1.png");
        
        tree1.paintIcon(this, g, 0, tree1ypos);
        num1= random.nextInt(500);
        tree1ypos +=50;
        
        tree2= new ImageIcon("src/assets/tree2.png");
        tree2.paintIcon(this, g, 0, tree2ypos);
        tree2ypos +=50;
        
        tree3= new ImageIcon("src/assets/tree3.png");
        ...
        car= new ImageIcon("src/assets/gamecar1.png");
        ...
        //Opposite car
        car1= new ImageIcon("src/assets/gamecar2.png");
        car2= new ImageIcon("src/assets/gamecar3.png");
        car3= new ImageIcon("src/assets/gamecar4.png");
     ...
     if(gameover){
       ...
       g.drawString("GameOver !!!! ", 240, 290);
       g.setFont(new Font("Serif", Font.BOLD, 40));
       g.setColor(Color.YELLOW);
       g.drawString("Press Enter to Restart", 160, 340);
       if(!paint){
           repaint();
           paint= true;
       }
